...
%-------------------------------------------------------------------------------
\input{example/resume/summary.tex}
\input{example/resume/experience.tex}
\input{example/resume/honors.tex}
\input{example/resume/certificates.tex}
% \input{resume/presentation.tex}
% \input{resume/writing.tex}
% \input{resume/committees.tex}
\input{example/resume/education.tex}
